...
class Detail(models.Model):
    ...
    id = models.IntegerField('id', primary_key=True)
    father_id = models.IntegerField('father_id')
    father_detail_id = models.IntegerField('father_detail_id')
...
class Demand(models.Model):
    ...
    id = models.IntegerField('id', primary_key=True)
    due_time = models.DateTimeField('due_time')
    ...
    check_time = models.DateTimeField('check_time')
